...
export class createTables1667917409544 implements MigrationInterface {
    name = 'createTables1667917409544'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "skill" ("id" uuid NOT NULL, "name" character varying NOT NULL, "type" character varying NOT NULL, "url_image" character varying NOT NULL, "userId" uuid, CONSTRAINT "UQ_0f49a593960360f6f85b692aca8" UNIQUE ("name"), CONSTRAINT "PK_a0d33334424e64fb78dc3ce7196" PRIMARY KEY ("id"))`);
